...
var things = ["Music", "Fashion", "Dance", "Theater", "Math", "Code",];
var programmers = ["musician", "style icon", "choreographer", "director", "mathematician", "programmer"]
...
q.innerHTML =
    "\"The " + programmer +
    ", like the actress, works only slightly removed from Hollywood. She builds her " +
    castles + " in the " + air + ", from " + air + ", creating by " + exertion + " of the imagination.\"" +
    "\u2014" +  "Anna Wintour, " + programmer;
